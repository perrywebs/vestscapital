        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="md:col-span-2">
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-8 animate-fade-in stagger-item">
                    ...
                    <form action="<?php echo e(route('user.plans.payment.process', $userPlan->id)); ?>" method="POST" id="paymentForm">
                        <?php echo csrf_field(); ?>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="mt-1 text-sm font-medium text-indigo-600 dark:text-indigo-400">
                                                Available: <?php echo e(Auth::user()->currency); ?><?php echo e(number_format(auth()->user()->account_bal, 2)); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="payment-sections">
                            ...
                            <div id="wallet-section" class="payment-section">
                                ...
                                <?php if(auth()->user()->account_bal < $userPlan->invested_amount): ?>
                                ...
                                <a href="<?php echo e(route('user.deposits.new')); ?>" class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-md transition-colors duration-300">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                        <div class="relative">
                                            ...
                                            <label for="btc" class="block cursor-pointer p-4 border border-gray-300 dark:border-gray-600 rounded-lg peer-checked:border-indigo-500 peer-checked:ring-2 peer-checked:ring-indigo-500 hover:border-gray-400 dark:hover:border-gray-500">
                                                <div class="flex items-center">
                                                    <img src="<?php echo e(asset('dash/bitcoin-btc-logo.png')); ?>" alt="Bitcoin" class="h-8 w-8 mr-3">
                                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <label for="eth" class="block cursor-pointer p-4 border border-gray-300 dark:border-gray-600 rounded-lg peer-checked:border-indigo-500 peer-checked:ring-2 peer-checked:ring-indigo-500 hover:border-gray-400 dark:hover:border-gray-500">
                                                <div class="flex items-center">
                                                    <img src="<?php echo e(asset('dash/ethereum-eth-logo.png')); ?>" alt="Ethereum" class="h-8 w-8 mr-3">
                                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <label for="usdt" class="block cursor-pointer p-4 border border-gray-300 dark:border-gray-600 rounded-lg peer-checked:border-indigo-500 peer-checked:ring-2 peer-checked:ring-indigo-500 hover:border-gray-400 dark:hover:border-gray-500">
                                                <div class="flex items-center">
                                                    <img src="<?php echo e(asset('dash/tether-usdt-logo.png')); ?>" alt="USDT" class="h-8 w-8 mr-3">
                                                    <div>
                            ...
                            <div id="bank-section" class="payment-section hidden">
                                <div class="mb-6">
                                    <div class="p-6 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 mb-6">
                                        ...
                                        <p class="text-gray-600 dark:text-gray-300 mb-4">Please transfer <span class="font-bold text-indigo-600 dark:text-indigo-400"><?php echo e(Auth::user()->currency); ?><?php echo e(number_format($userPlan->invested_amount, 2)); ?></span> to the following bank account:</p>

                                        <div class="space-y-3">
                                            <div class="flex justify-between">
                                                <span class="text-gray-600 dark:text-gray-400">Bank Name:</span>
                                                <span class="font-medium text-gray-900 dark:text-white"><?php echo e(config('app.bank_name', 'BlueTrade Bank')); ?></span>
                                            </div>

                                            <div class="flex justify-between">
                                                <span class="text-gray-600 dark:text-gray-400">Account Name:</span>
                                                <span class="font-medium text-gray-900 dark:text-white"><?php echo e(config('app.account_name', 'BlueTrade Ltd')); ?></span>
                                            </div>

                                            <div class="flex justify-between">
                                                <span class="text-gray-600 dark:text-gray-400">Account Number:</span>
                                                <span class="font-medium text-gray-900 dark:text-white"><?php echo e(config('app.account_number', '1234567890')); ?></span>
                                            </div>

                                            <div class="flex justify-between">
                                                <span class="text-gray-600 dark:text-gray-400">Sort Code/Routing Number:</span>
                                                <span class="font-medium text-gray-900 dark:text-white"><?php echo e(config('app.sort_code', '012345')); ?></span>
                                            </div>

                                            <div class="flex justify-between">
                                                <span class="text-gray-600 dark:text-gray-400">Reference:</span>
                                                <span class="font-medium text-gray-900 dark:text-white">INV-<?php echo e($userPlan->id); ?>-<?php echo e(Auth::user()->id); ?></span>
                                            </div>
                                        </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 animate-fade-in stagger-item">
                        ...
                        <div class="mb-4 pb-4 border-b border-gray-200 dark:border-gray-700">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="font-medium text-gray-900 dark:text-white"><?php echo e($userPlan->plan->name); ?></span>
                            </div>
                            <div class="flex items-center justify-between mb-2">
                                <span class="text-gray-600 dark:text-gray-300">Duration:</span>
                                <span class="font-medium text-gray-900 dark:text-white"><?php echo e($userPlan->plan->duration); ?> <?php echo e(Str::plural('Day', $userPlan->plan->duration)); ?></span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span class="text-gray-600 dark:text-gray-300">Return Rate:</span>
                                <span class="font-medium text-green-600 dark:text-green-500"><?php echo e($userPlan->plan->expected_return); ?>% / <?php echo e($userPlan->plan->return_interval); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="mb-4 pb-4 border-b border-gray-200 dark:border-gray-700">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="font-medium text-gray-900 dark:text-white"><?php echo e(Auth::user()->currency); ?><?php echo e(number_format($userPlan->invested_amount, 2)); ?></span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span class="text-gray-600 dark:text-gray-300">Expected Profit:</span>
                                <span class="font-medium text-green-600 dark:text-green-500"><?php echo e(Auth::user()->currency); ?><?php echo e(number_format($userPlan->expected_profit, 2)); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="flex items-center justify-between text-lg font-bold">
                                ...
                                <span class="text-indigo-600 dark:text-indigo-400"><?php echo e(Auth::user()->currency); ?><?php echo e(number_format($userPlan->invested_amount + $userPlan->expected_profit, 2)); ?></span>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\user\plan\payment.blade.php ENDPATH**/ ?>