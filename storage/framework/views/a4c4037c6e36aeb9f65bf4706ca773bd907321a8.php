    ...
    <div class="mb-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between animate-fade-in">
            ...
            <div class="mt-4 md:mt-0">
                <a href="<?php echo e(route('user.plans.my')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors duration-300">
...
<?php endif; ?>
    ...
    <div class="mb-8 overflow-x-auto">
        <div class="inline-flex items-center space-x-2 pb-2">
            <a href="<?php echo e(route('user.plans.index')); ?>" class="category-pill px-4 py-2 rounded-full text-sm font-medium <?php echo e($categoryId === null ? 'active' : 'text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-800'); ?>">
                All Plans
            </a>

            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('user.plans.index', ['category' => $category->id])); ?>" class="category-pill px-4 py-2 rounded-full text-sm font-medium <?php echo e($categoryId == $category->id ? 'active' : 'text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-800'); ?>">
                <?php echo e($category->name); ?>

                <span class="ml-1 text-xs bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full px-2 py-0.5"><?php echo e($category->plans_count); ?></span>
            </a>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="stagger-item animate-fade-in plan-card rounded-xl overflow-hidden <?php echo e($plan->featured ? 'featured' : ''); ?> bg-white dark:bg-gray-800">
            <!-- Plan Header -->
            <div class="relative">
                <div class="p-6 <?php echo e($plan->featured ? 'bg-gradient-to-r from-indigo-600 to-purple-600' : 'bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800'); ?>">
                    <?php if($plan->badge_text): ?>
                    <span class="absolute top-4 right-4 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($plan->featured ? 'bg-white text-indigo-600' : 'bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-200'); ?>">
                        <?php echo e($plan->badge_text); ?>

                    </span>
                    <?php endif; ?>

                    <h3 class="text-2xl font-bold mb-2 <?php echo e($plan->featured ? 'text-white' : 'text-gray-800 dark:text-white'); ?>"><?php echo e($plan->name); ?></h3>

                    <div class="flex items-baseline mb-4">
                        <span class="text-3xl font-extrabold <?php echo e($plan->featured ? 'text-white' : 'text-gray-900 dark:text-white'); ?>">
                            <?php echo e(Auth::user()->currency); ?><?php echo e(number_format($plan->min_price, 2)); ?>

                        </span>
                        <span class="ml-2 <?php echo e($plan->featured ? 'text-indigo-100' : 'text-gray-500 dark:text-gray-400'); ?>">
                            min investment
                        </span>
                    </div>

                    <div class="<?php echo e($plan->featured ? 'text-white' : 'text-gray-700 dark:text-gray-300'); ?>">
                        <div class="flex items-center mb-1">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                            </svg>
                            <span><?php echo e($plan->min_return); ?>% - <?php echo e($plan->max_return); ?>% ROI</span>
                        </div>
                        <div class="flex items-center mb-1">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            <span><?php echo e($plan->duration); ?> <?php echo e(Str::plural($plan->duration_type, $plan->duration)); ?></span>
                        </div>
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            </svg>
                            <span><?php echo e(ucfirst($plan->payout_interval)); ?> payouts</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6">
                ...
                <p class="text-gray-600 dark:text-gray-400 mb-4"><?php echo e($plan->description); ?></p>
                <?php endif; ?>
                ...
                <ul class="space-y-3 mb-6">
                    ...
                    <li class="flex items-start">
                        ...
                        <?php endif; ?>
                        <span class="text-gray-700 dark:text-gray-300"><?php echo e($feature->feature); ?></span>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>

                <a href="<?php echo e(route('user.plans.show', $plan->id)); ?>" class="block w-full text-center py-3 px-4 rounded-lg <?php echo e($plan->featured ? 'bg-indigo-600 hover:bg-indigo-700 text-white' : 'bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-white'); ?> font-medium transition-colors duration-300">
                    View Details
                </a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\user\plan\index.blade.php ENDPATH**/ ?>