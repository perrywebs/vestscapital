        ...
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl shadow-lg text-white p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold"><?php echo e($activeTrades->count()); ?></p>
                </div>
        ...
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-lg text-white p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold">$<?php echo e(number_format($activeTrades->sum('amount'), 0)); ?></p>
                </div>
                <div class="bg-white/20 rounded-lg p-3">
        ...
        <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl shadow-lg text-white p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold">$<?php echo e(number_format($activeTrades->sum('profit'), 2)); ?></p>
                </div>
                <div class="bg-white/20 rounded-lg p-3">
        ...
        <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl shadow-lg text-white p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold"><?php echo e($activeTrades->count() > 0 ? number_format($activeTrades->avg('profit'), 2) : '0.00'); ?>%</p>
                </div>
                <div class="bg-white/20 rounded-lg p-3">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        <?php $__currentLoopData = $activeTrades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td class="py-4 px-6">
                                    <div class="flex items-center space-x-3">
                                        <div class="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold">
                                            <?php if($trade->user): ?>
                                                <?php echo e(substr($trade->user->name, 0, 1)); ?>
                                ...
                                <td class="py-4 px-6">
                                    <div class="flex items-center space-x-3">
                                        <?php if($trade->expert && $trade->expert->photo): ?>
                                            <img src="<?php echo e(asset('storage/' . $trade->expert->photo)); ?>" 
                                                 class="w-10 h-10 rounded-full object-cover border-2 border-gray-200 dark:border-gray-600"
                                                 alt="<?php echo e($trade->expert->name); ?>">
                                        <?php else: ?>
                                            <div class="w-10 h-10 rounded-full bg-gradient-to-br from-green-500 to-blue-600 flex items-center justify-center text-white font-bold">
                                                <?php if($trade->expert): ?>
                                                    <?php echo e(substr($trade->expert->name, 0, 1)); ?>
                                ...
                                <td class="py-4 px-6">
                                    <div class="text-lg font-semibold text-gray-900 dark:text-white">
                                        $<?php echo e(number_format((float)$trade->amount, 2)); ?>
                                ...
                                <td class="py-4 px-6">
                                    <?php if($trade->profit > 0): ?>
                                        <div class="text-lg font-semibold text-green-600 dark:text-green-400">
                                            +$<?php echo e(number_format((float)$trade->profit, 2)); ?>

                                        </div>
                                        <div class="text-sm text-green-600 dark:text-green-400">
                                            Profit
                                        </div>
                                    <?php elseif($trade->profit < 0): ?>
                                        <div class="text-lg font-semibold text-red-600 dark:text-red-400">
                                            -$<?php echo e(number_format(abs((float)$trade->profit), 2)); ?>
                                ...
                                <td class="py-4 px-6">
                                    ...
                                    <div class="text-xs text-gray-600 dark:text-gray-400">
                                        Started <?php echo e($trade->created_at->format('M j, Y')); ?>
                                ...
                                <td class="py-4 px-6">
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <?php if($trade->expert && $trade->expert->status === 'active'): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\admin\copy\active-trades.blade.php ENDPATH**/ ?>