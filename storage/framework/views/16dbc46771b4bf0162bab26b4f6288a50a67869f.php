...
} elseif ($_instance->childHasBeenRendered('WIG5KzQ')) {
    $componentId = $_instance->getRenderedChildComponentId('WIG5KzQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('WIG5KzQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WIG5KzQ');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('WIG5KzQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>