		...
		<div class="main-panel">
			<div class="content bg-<?php echo e($bg); ?>">
				<div class="page-inner">
					<div class="mt-2 mb-4">
						<h1 class="title1 text-<?php echo e($text); ?>">Add Copy Trading  Paln</h1>
					</div>
					...
					<div class="mb-5 row">
						<div class="col-lg-10  ">
                            <div class="p-3 card bg-<?php echo e($bg); ?>">
                                <form role="form" method="post" action="<?php echo e(route('addcopytrading')); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="form-row">
                                        <div class="form-group col-md-5">
                                            <h5 class="text-<?php echo e($text); ?>">Expert Trader Tag (MID/PRO)</h5>
                                            <input  class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>" placeholder="Enter Expert Trader Tag" type="text" name="tag" required>
                                        </div>
                                        <div class="form-group col-md-5">
                                            <h5 class="text-<?php echo e($text); ?>">Trader Name</h5> 
                                            <input class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>" placeholder="Enter Expert Trader Name" type="text" name="name" required>   
                                            
                                       </div>	
                                       <div class="form-group col-md-5">
                                            <h5 class="text-<?php echo e($text); ?>">Expert Trader Number of Followers</h5> 			 
                                             <input placeholder="Enter Expert Trader Number of Followers" class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>" type="text" name="followers" required>  
                                       ...
                                       <div class="form-group col-md-5">
                                             ...
                                             <input class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>" placeholder="Enter Expert Total profit" type="text" name="total_profit" required> 
                                       ...
                                       <div class="form-group col-md-5">
                                            ...
                                            <select class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>" name="button_name">
                                                <option>Copy</option>
                                                <option>Buy</option>
                                       ...
                                       <div class="form-group col-md-5">
                                           ...
                                           <input class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>" placeholder="Enter maximum return" type="text" name="active_days" required>  
                                       ...
                                       <div class="form-group col-md-5">
                                           ...
                                           <input class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>" placeholder="Enter Expert trade Equity" type="text" name="equity" value="0" required>  
                                       ...
                                       <div class="form-group col-md-5">
                                           ...
                                           <input class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>" placeholder=" Startup Amount" type="text" name="price" required> 
                                       ...
                                       <div class="form-group col-md-5">
                                        <h5 class="text-<?php echo e($text); ?>">Expert Trader rating</h5> 
                                           <input class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>" placeholder="Expert Trader rating" type="number" name="rating" required> 
                                           <small class="text-<?php echo e($text); ?>">This Expert Trader rating  (Max is 5 stars)  </small> 
                                       ...
                                       <div class="form-group col-md-5">
                                        <h5 class="text-<?php echo e($text); ?>">Expert Trader Photo</h5> 
                                           <input class="form-control text-<?php echo e($text); ?> bg-<?php echo e($bg); ?>" placeholder="Expert Trader photo" type="file"  name="photo" required> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\admin\copytrading\newcopytrading.blade.php ENDPATH**/ ?>