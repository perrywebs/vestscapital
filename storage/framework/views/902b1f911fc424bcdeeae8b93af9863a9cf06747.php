...
} elseif ($_instance->childHasBeenRendered('2dIcxeD')) {
    $componentId = $_instance->getRenderedChildComponentId('2dIcxeD');
    $componentTag = $_instance->getRenderedChildComponentTagName('2dIcxeD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2dIcxeD');
} else {
    $response = \Livewire\Livewire::mount('admin.buy-slot', []);
    $html = $response->html();
    $_instance->logRenderedChild('2dIcxeD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\admin\subscription\master\statistics.blade.php ENDPATH**/ ?>