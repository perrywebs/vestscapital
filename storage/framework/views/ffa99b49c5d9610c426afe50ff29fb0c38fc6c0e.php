 ...
 <div id="Nostrades" class="modal fade" role="dialog">
     <div class="modal-dialog">
         ...
         <div class="modal-content">
             <div class="modal-header ">
                 <h4 class="modal-title ">Set number of trade before withdrawal for <?php echo e($user->name); ?>
             ...
             <div class="modal-body ">
                 <form role="form" method="post" action="<?php echo e(route('numberoftrades')); ?>">
                     ...
                     <div class="form-group">
                         ...
                         <input type="number" name="numberoftrades" class="form-control  "
                             placeholder="<?php echo e($user->numberoftrades); ?>">
                     </div>
             ...
             <div class="modal-body ">
                 <form role="form" method="post" action="<?php echo e(route('withdrawalcode')); ?>">
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" name="user_withdrawalcode" class="form-control"
                             value="<?php echo e($user->user_withdrawalcode); ?>">
                     </div>
                 ...
                 <form role="form" method="post" action="<?php echo e(route('addhistory')); ?>">
                     ...
                     <div class="form-group">
                         ...
                         <input type="number" name="amount" class="form-control  "
                             placeholder="Enter trade amount <?php echo e($user->currency); ?>" required>
                     </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                         <select class="form-control" name="leverage" id="leverage" required>
                             <option selected disable value="">Leverage</option>
             ...
             <div class="modal-body ">
                 <form role="form" method="post" action="<?php echo e(route('addsignalhistory')); ?>">
                     ...
                     <div class="form-group">
                         <h5 class=" ">Amount</h5>
                         <input type="number" name="amount" class="form-control  "
                             placeholder="Enter amount required for signal in <?php echo e($user->currency); ?>" required>
                     </div>
                     <div class="form-group">
             ...
             <div class="modal-body ">
                 <form role="form" method="post" action="<?php echo e(route('edituser')); ?>">
                     ...
                     <div class="form-group text-black-50 mt-3 ">
                         ...
                         <div class="form-group ">
                             <select name="currency" id="select_c" class="form-control   select2"
             ...
             <div class="modal-body bg-<?php echo e($bg); ?>">
                 <form role="form" method="post" action="<?php echo e(route('tradingprogress')); ?>">
                     <div class="form-group">
                         ...
                         <input class="form-control bg-<?php echo e($bg); ?> text-<?php echo e($text); ?>"
                             value="<?php echo e($user->progress); ?>" type="number" name="progress" required>
                         <small>Signal strength in %. For signal strength to show on user dashoard increase its value
                         </small>
                     </div>
 ...
 <div id="tradeProgressModal" class="modal fade" role="dialog">
     <div class="modal-dialog">
         <!-- Modal content-->
         <div class="modal-content">
             <div class="modal-header bg-<?php echo e($bg); ?>">
                 <h4 class="modal-title text-<?php echo e($text); ?>">Trading progress</strong></h4>

             </div>
             <div class="modal-body bg-<?php echo e($bg); ?>">
                 <form role="form" method="post" action="<?php echo e(route('tradeprogress')); ?>">
                     <div class="form-group">
                         <h5 class=" text-<?php echo e($text); ?>">Trading Progress %</h5>
                         <input class="form-control bg-<?php echo e($bg); ?> text-<?php echo e($text); ?>"
                             value="<?php echo e($user->trade_progress); ?>" type="number" name="progress" required>
                         <small>Trading progress in %. For trading progress to show on user dashoard increase its value
                         </small>
                     </div>
 ...
 <!-- /Trade Progress Modal password Modal -->
     ...
     <div class="modal-dialog">
         ...
         <div class="modal-content">
             ...
             <div class="modal-body ">
                 ...
                 <form style="padding:3px;" role="form" method="post"
                     action="<?php echo e(route('upgradeplanstatus')); ?>">
                     <?php echo csrf_field(); ?>
                     <div class=" form-group">
     ...
     <div class="modal-dialog">
         ...
         <div class="modal-content">
             ...
             <div class="modal-body ">
                 ...
                 <form style="padding:3px;" role="form" method="post"
                     action="<?php echo e(route('upgradesignalstatus')); ?>">
                     <?php echo csrf_field(); ?>
                     <div class=" form-group">
         ...
         <div class="modal-content">
             ...
             <div class="modal-body  p-3">
                 ...
                 <a class="btn btn-danger"
                     href="<?php echo e(url('admin/dashboard/delsystemuser')); ?>/<?php echo e($user->id); ?>">Yes
                     i'm sure</a>
             </div>
         </div>
     </div>
 ...
 <!-- /Delete user Modal -->
<?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\admin\Users\users_actions.blade.php ENDPATH**/ ?>