...
} elseif ($_instance->childHasBeenRendered('CXSacCb')) {
    $componentId = $_instance->getRenderedChildComponentId('CXSacCb');
    $componentTag = $_instance->getRenderedChildComponentTagName('CXSacCb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('CXSacCb');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('CXSacCb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
