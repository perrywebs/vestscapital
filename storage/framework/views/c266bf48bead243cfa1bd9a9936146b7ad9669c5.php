    ...
    <div class="container mx-auto px-6">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <nav class="flex mb-4" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        <li class="inline-flex items-center">
                            <a href="<?php echo e(route('user.bots.dashboard')); ?>" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                ...
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($investment->bot->name ?? 'Bot'); ?> Trading History</h1>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="text-center">
                        ...
                        <div class="text-2xl font-bold text-gray-900 dark:text-white">$<?php echo e(number_format($investment->amount, 2)); ?></div>
                    ...
                    <div class="text-center">
                        ...
                        <div class="text-2xl font-bold text-gray-900 dark:text-white">$<?php echo e(number_format($investment->current_balance, 2)); ?></div>
                        <div class="text-sm text-gray-600 dark:text-gray-400">Current Balance</div>
                    </div>

                    <!-- Total Profit/Loss -->
                    <div class="text-center">
                        <div class="w-12 h-12 <?php echo e(($investment->total_profit - $investment->total_loss) >= 0 ? 'bg-green-100 dark:bg-green-900/30' : 'bg-red-100 dark:bg-red-900/30'); ?> rounded-xl flex items-center justify-center mx-auto mb-3">
                            <svg class="w-6 h-6 <?php echo e(($investment->total_profit - $investment->total_loss) >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e(($investment->total_profit - $investment->total_loss) >= 0 ? 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' : 'M13 17h8m0 0V9m0 8l-8-8-4 4-6-6'); ?>"></path>
                            </svg>
                        </div>
                        <div class="text-2xl font-bold <?php echo e(($investment->total_profit - $investment->total_loss) >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                            <?php echo e(($investment->total_profit - $investment->total_loss) >= 0 ? '+' : ''); ?>$<?php echo e(number_format($investment->total_profit - $investment->total_loss, 2)); ?>
                    ...
                    <div class="text-center">
                        ...
                        ?>
                        <div class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($winRate, 1)); ?>%</div>
                ...
                <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                        <div>
                            <div class="text-lg font-semibold text-gray-900 dark:text-white"><?php echo e($investment->successful_trades + $investment->failed_trades); ?></div>
                            <div class="text-xs text-gray-600 dark:text-gray-400">Total Trades</div>
                        </div>
                        <div>
                            <div class="text-lg font-semibold text-green-600"><?php echo e($investment->successful_trades); ?></div>
                            <div class="text-xs text-gray-600 dark:text-gray-400">Winning Trades</div>
                        </div>
                        <div>
                            <div class="text-lg font-semibold text-red-600"><?php echo e($investment->failed_trades); ?></div>
                            <div class="text-xs text-gray-600 dark:text-gray-400">Losing Trades</div>
                        </div>
                        <div>
                            <div class="text-lg font-semibold text-gray-900 dark:text-white">
                                <?php echo e($investment->created_at->diffInDays(now())); ?> days
                            </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                    <span class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($trades->total()); ?> total trades</span>
                </div>
            </div>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    <td class="py-4 px-6">
                                        <div>
                                            <div class="font-medium text-gray-900 dark:text-white">
                                                <?php echo e($trade->trading_pair ?? 'N/A'); ?>

                                            </div>
                                            <div class="text-sm text-gray-600 dark:text-gray-400">
                                                Entry: $<?php echo e(number_format($trade->entry_price, 4)); ?>

                                                → Exit: $<?php echo e(number_format($trade->exit_price, 4)); ?>
                                    ...
                                    <td class="py-4 px-6">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                            <?php echo e($trade->trade_type == 'BUY' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300'); ?>">
                                            <?php echo e($trade->trade_type ?? 'N/A'); ?>
                                    ...
                                    <td class="py-4 px-6">
                                        <div class="flex items-center">
                                            <span class="font-semibold <?php echo e($trade->profit_loss >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                                                <?php echo e($trade->profit_loss >= 0 ? '+' : ''); ?>$<?php echo e(number_format($trade->profit_loss, 2)); ?>

                                            </span>
                                            <span class="ml-2 text-xs text-gray-500 dark:text-gray-400">
                                                (<?php echo e($trade->profit_loss >= 0 ? '+' : ''); ?><?php echo e(number_format($trade->profit_percentage, 2)); ?>%)
                                            </span>
                                        </div>
                                    </td>
                                    <td class="py-4 px-6 text-gray-600 dark:text-gray-400">
                                        <?php echo e($trade->strategy_used ?? 'Auto'); ?>

                                    </td>
                                    <td class="py-4 px-6 text-gray-600 dark:text-gray-400">
                                        <?php if($trade->opened_at && $trade->closed_at): ?>
                                            <?php
                                                $duration = \Carbon\Carbon::parse($trade->opened_at)->diffInMinutes(\Carbon\Carbon::parse($trade->closed_at));
                                            ?>
                                            <?php echo e($duration >= 60 ? number_format($duration / 60, 1) . 'h' : $duration . 'm'); ?>
                                    ...
                                    <td class="py-4 px-6">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                            <?php echo e($trade->result == 'profit' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300'); ?>">
                                            <?php echo e(ucfirst($trade->result ?? 'completed')); ?>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\user\bot\history.blade.php ENDPATH**/ ?>