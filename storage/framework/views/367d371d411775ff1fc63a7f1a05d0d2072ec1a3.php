        ...
        <div class="bg-gray-900 rounded-xl p-4 sm:p-6 border border-gray-800">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-white text-xl sm:text-2xl font-bold mt-1">$<?php echo e(number_format(Auth::user()->ref_bonus ?? 0, 2)); ?></p>
                </div>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views/user/referuser.blade.php ENDPATH**/ ?>