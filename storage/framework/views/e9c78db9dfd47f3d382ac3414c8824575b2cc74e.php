...
<?php endif; ?>
        ...
        <!-- Signal Strength -->
        <?php if(Auth::user()->trade_progress > 1): ?>
            <div class="mb-6 sm:mb-8">
                ...
                <div
                    ...
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <div class="flex items-center gap-2">
                            <span
                                class="text-lg sm:text-xl font-bold text-gray-900 dark:text-white"><?php echo e($signalStrength); ?>%</span>
                            <span
                                class="px-2 py-1 text-xs font-medium rounded-full
                        <?php echo e($signalStrength < 25
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            <div
                                ...
                                <?php if($instrument->logo): ?>
                                    <img src="<?php echo e($instrument->logo); ?>" alt="<?php echo e($instrument->name); ?>"
                                        class="w-10 h-10 rounded-full object-cover">
                                <?php else: ?>
                                    <span
                                        class="text-gray-500 dark:text-gray-400 font-semibold"><?php echo e(substr($instrument->symbol, 0, 2)); ?></span>
                                <?php endif; ?>
                            </div>
                            <div>
                        ...
                        <div class="text-right">
                            ...
                            <div
                                class="flex items-center gap-1 <?php echo e($instrument->percent_change_24h >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>">
                                ...
                                <span
                                    class="text-sm">(<?php echo e($instrument->change >= 0 ? '+' : ''); ?>$<?php echo e(number_format($instrument->change, 2)); ?>)</span>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <?php $__currentLoopData = $openTrades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div
                                        ...
                                        <div class="flex items-center justify-between mb-4">
                                            ...
                                            <div class="text-right">
                                                <div
                                                    class="text-lg font-bold <?php echo e($trade->type === 'Buy' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>">
                                        ...
                                        <div class="space-y-3">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center gap-3">
                                                    <div
                                                        class="w-10 h-10 rounded-full <?php echo e($trade->type === 'Buy' ? 'bg-green-100 dark:bg-green-900/30' : 'bg-red-100 dark:bg-red-900/30'); ?> flex items-center justify-center">
                                                ...
                                                <div class="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-3">
                                                    <div class="flex justify-between items-center mb-2">
                                                        <span
                                                            ...
                                                            Progress</span>
                                                        <span
                                                            class="text-xs text-gray-600 dark:text-gray-400"><?php echo e($timeLeft); ?></span>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <span>Started
                                                            <?php echo e(\Carbon\Carbon::parse($trade->created_at)->diffForHumans()); ?></span>
                                            ...
                                            <div class="grid grid-cols-2 gap-3 text-sm">
                                                <div class="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-2">
                                                    ...
                                                    <div class="font-medium text-gray-900 dark:text-white">
                                                        <?php echo e($trade->inv_duration ?? 'N/A'); ?></div>
                                                </div>
                                                <div class="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-2">
                                                    <div class="text-gray-600 dark:text-gray-400 text-xs">Current P&L</div>
                                                    <div
                                                        class="font-medium <?php echo e(($trade->profit_earned ?? 0) >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>">
                                        ...
                                        <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-600">
                                            <a href="<?php echo e(route('trade.monitor', $trade->id)); ?>"
                        ...
                        <?php else: ?>
                            <div class="text-center py-12">
                                ...
                                <p class="text-gray-600 dark:text-gray-400 mb-4">You don't have any open trades for
                                    <?php echo e($instrument->symbol); ?></p>
                                <button
                                        ...
                                        <div class="flex items-center justify-between mb-4">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <?php elseif($trade->active === 'expired'): ?>
                                                    <!-- Closed Trade -->
                                                    <div
                                                        class="w-8 h-8 rounded-full <?php echo e($isSuccessful ? 'bg-green-100 dark:bg-green-900/30' : 'bg-red-100 dark:bg-red-900/30'); ?> flex items-center justify-center">
                                                        <?php if($isSuccessful): ?>
                                                            <i data-lucide="check"
                                                    ...
                                                    <span
                                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($isSuccessful ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400'); ?>">
                                                        <div
                                                            class="w-2 h-2 rounded-full <?php echo e($isSuccessful ? 'bg-green-500' : 'bg-red-500'); ?> mr-1">
                                                        </div>
                                                ...
                                                <div class="grid grid-cols-2 gap-3">
                                                    <div>
                                                        ...
                                                        <?php if($trade->active === 'expired'): ?>
                                                            <div
                                                                class="font-semibold <?php echo e($isProfit ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>">
                        ...
                        <?php else: ?>
                            <div class="text-center py-12">
                                ...
                                <p class="text-gray-600 dark:text-gray-400 mb-4">You haven't completed any trades for
                                    <?php echo e($instrument->symbol); ?> yet</p>
                                <div class="space-y-3">
                                    <button
                                        class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors text-sm font-medium">
                                        Start Trading
                                    ...
                                    <div>
                                        <a href="<?php echo e(url('user-trades-debug.php')); ?>"
            ...
            <div class="xl:col-span-1">
                <div
                    ...
                    <!-- Order Form -->
                    <form action="<?php echo e(route('joinplan')); ?>" method="POST" class="space-y-4"
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span
                                    class="text-sm text-gray-900 dark:text-white">$<?php echo e(number_format(auth()->user()->account_bal ?? 0, 2)); ?></span>
                            </div>
                        </div>
                        ...
                        <button type="submit" :disabled="!amount || amount <= 0 || loading"
                            ...
                            <span
                                x-text="loading ? 'Processing...' : (orderType === 'Buy' ? 'Buy ' + '<?php echo e($instrument->symbol); ?>' : 'Sell ' + '<?php echo e($instrument->symbol); ?>')"></span>
                        </button>
                    </form>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views/user/trade/single.blade.php ENDPATH**/ ?>