        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                <div class="flex items-center gap-2 px-3 py-2 bg-gray-800 rounded-lg border border-gray-700">
                    ...
                    <span class="text-xs text-gray-400"><?php echo e($transactions->total()); ?> Total Transactions</span>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-3">
                                    <div class="w-8 h-8 bg-orange-500/20 rounded-lg flex items-center justify-center">
                                        <span class="text-xs font-bold text-orange-400"><?php echo e(strtoupper($tran->source)); ?></span>
                                    </div>
                                    <span class="text-sm font-medium text-white"><?php echo e(strtoupper($tran->source)); ?></span>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-3">
                                    <div class="w-8 h-8 bg-green-500/20 rounded-lg flex items-center justify-center">
                                        <span class="text-xs font-bold text-green-400"><?php echo e(strtoupper($tran->dest)); ?></span>
                                    </div>
                                    <span class="text-sm font-medium text-white"><?php echo e(strtoupper($tran->dest)); ?></span>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm">
                                    <div class="font-medium text-white"><?php echo e(number_format($tran->amount, 8)); ?></div>
                                    <div class="text-gray-400"><?php echo e(strtoupper($tran->source)); ?></div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm">
                                    <div class="font-medium text-white"><?php echo e(number_format($tran->quantity, 8)); ?></div>
                                    <div class="text-gray-400"><?php echo e(strtoupper($tran->dest)); ?></div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm">
                                    <div class="font-medium text-white"><?php echo e(\Carbon\Carbon::parse($tran->created_at)->format('M j, Y')); ?></div>
                                    <div class="text-gray-400"><?php echo e(\Carbon\Carbon::parse($tran->created_at)->format('g:i A')); ?></div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                ...
                <div class="bg-gray-700 border border-gray-600 rounded-xl p-4 hover:bg-gray-600/50 transition-colors duration-200">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-3">
                        <div>
                            ...
                            <div class="text-sm font-medium text-white"><?php echo e(number_format($tran->amount, 8)); ?></div>
                            <div class="text-xs text-gray-400"><?php echo e(strtoupper($tran->source)); ?></div>
                        </div>
                        <div>
                            <div class="text-xs text-gray-400 mb-1">Received</div>
                            <div class="text-sm font-medium text-white"><?php echo e(number_format($tran->quantity, 8)); ?></div>
                            <div class="text-xs text-gray-400"><?php echo e(strtoupper($tran->dest)); ?></div>
                        </div>
                    </div>

                    <div class="pt-3 border-t border-gray-600">
                        <div class="flex items-center justify-between text-xs text-gray-400">
                            <span><?php echo e(\Carbon\Carbon::parse($tran->created_at)->format('M j, Y g:i A')); ?></span>
                ...
                <div class="bg-gray-700 border border-gray-600 rounded-xl p-6 hover:bg-gray-600/50 transition-all duration-200 hover:shadow-xl">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="flex items-center gap-2">
                                <div class="w-10 h-10 bg-orange-500/20 rounded-xl flex items-center justify-center">
                                    <span class="text-sm font-bold text-orange-400"><?php echo e(strtoupper($tran->source)); ?></span>
                                </div>
                                <i data-lucide="arrow-right" class="w-5 h-5 text-gray-400"></i>
                                <div class="w-10 h-10 bg-green-500/20 rounded-xl flex items-center justify-center">
                                    <span class="text-sm font-bold text-green-400"><?php echo e(strtoupper($tran->dest)); ?></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-2 gap-6 mb-4">
                        <div class="text-center p-4 bg-gray-800 rounded-lg">
                            ...
                            <div class="text-lg font-bold text-white"><?php echo e(number_format($tran->amount, 8)); ?></div>
                            <div class="text-sm text-gray-400"><?php echo e(strtoupper($tran->source)); ?></div>
                        </div>
                        <div class="text-center p-4 bg-gray-800 rounded-lg">
                            <div class="text-xs text-gray-400 mb-2">Amount Received</div>
                            <div class="text-lg font-bold text-white"><?php echo e(number_format($tran->quantity, 8)); ?></div>
                            <div class="text-sm text-gray-400"><?php echo e(strtoupper($tran->dest)); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="pt-4 border-t border-gray-600">
                        <div class="flex items-center justify-between">
                            <div>
                                <div class="text-sm font-medium text-white"><?php echo e(\Carbon\Carbon::parse($tran->created_at)->format('M j, Y')); ?></div>
                                <div class="text-xs text-gray-400"><?php echo e(\Carbon\Carbon::parse($tran->created_at)->format('g:i A')); ?></div>
                            </div>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\user\crypto-transaction.blade.php ENDPATH**/ ?>