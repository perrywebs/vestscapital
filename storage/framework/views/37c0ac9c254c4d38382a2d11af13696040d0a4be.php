...
} elseif ($_instance->childHasBeenRendered('1eXNERH')) {
    $componentId = $_instance->getRenderedChildComponentId('1eXNERH');
    $componentTag = $_instance->getRenderedChildComponentTagName('1eXNERH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1eXNERH');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('1eXNERH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\admin\Settings\AppSettings\show.blade.php ENDPATH**/ ?>