...
<head>
    ...
    <meta name="description"
        content="<?php echo e($settings->site_description ?? $settings->site_name); ?>">
    <meta name="keywords"
        content="<?php echo e($settings->site_keywords ?? $settings->site_name); ?>">
    ...
    <meta property="og:title" content="<?php echo e($settings->site_name); ?>">
    ...
    <meta property="og:image:secure_url" content="<?php echo e($socialImageUrl); ?>">
    <meta property="og:image:type" content="image/jpeg">
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="630">
    <meta property="og:image:alt" content="<?php echo e($settings->site_name); ?>">
    ...
    <meta name="twitter:title" content="<?php echo e($settings->site_name); ?>">
    <meta name="twitter:description"
        content="<?php echo e($settings->site_description ?? $settings->site_name); ?>">
    <meta name="twitter:image" content="<?php echo e($socialImageUrl); ?>">
    <meta name="twitter:image:alt" content="<?php echo e($settings->site_name); ?>">
    ...
    <link href="<?php echo e(url('home-assets/css/fonts.css')); ?>"
        rel="stylesheet"
        media="screen">
    ...
    <link href="<?php echo e(url('home-assets/css/bootstrap.min.css')); ?>"
        rel="stylesheet"
        media="screen">
    ...
    <link href="<?php echo e(url('home-assets/css/slicknav.min.css')); ?>"
        rel="stylesheet">
    ...
    <link rel="stylesheet"
        href="<?php echo e(url('home-assets/css/swiper-bundle.min.css')); ?>">
    ...
    <link href="<?php echo e(url('home-assets/css/all.min.css')); ?>"
        rel="stylesheet"
        media="screen">
    ...
    <link href="<?php echo e(url('home-assets/css/animate.css')); ?>"
        rel="stylesheet">
    ...
    <link rel="stylesheet"
        href="<?php echo e(url('home-assets/css/magnific-popup.css')); ?>">
    ...
    <link rel="stylesheet"
        href="<?php echo e(url('home-assets/css/mousecursor.css')); ?>">
    ...
    <link href="<?php echo e(url('home-assets/css/custom.css')); ?>"
        rel="stylesheet"
        media="screen">
</head>
...
<body class="antialiased text-gray-200 bg-gray-900 font-sans min-h-screen flex flex-col">
    ...
    <div class="preloader">
        <div class="loading-container">
            ...
            <div id="loading-icon"><img src="<?php echo e(URL('storage/app/public/' . $settings->favicon)); ?>" alt="">
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="footer-info-box">
                        ...
                        <div class="footer-contact-items-list">
                            ...
                            <div class="footer-contact-item">
                                <div class="icon-box">
                                    <img src="<?php echo e(URL('home-assets/images/icon-location-white.svg')); ?>"
                                        alt="">
                                </div>
                                <div class="footer-contact-item-content">
                                    <p>Our Address</p>
