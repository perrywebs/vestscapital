...
<?php $__env->startSection('title', 'Two Factor Authentication - Secure Login'); ?>
            ...
            <?php if(Session::has('message')): ?>
                <div class="mb-6 p-4 bg-red-500/10 border border-red-500/20 rounded-xl">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-red-300 text-sm font-medium"><?php echo e(Session::get('message')); ?></span>
                    </div>
                </div>
            <?php endif; ?>

            <!-- 2FA Form -->
            <form method="POST" action="<?php echo e(route('twofalogin')); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- Hidden Logout Form -->
            <form id="logout-form" action="<?php echo e(route('adminlogout')); ?>" method="POST" class="hidden">
                <?php echo csrf_field(); ?>
            </form>
...
<?php echo $__env->make('layouts.guest1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\auth\two-factor-challenge.blade.php ENDPATH**/ ?>