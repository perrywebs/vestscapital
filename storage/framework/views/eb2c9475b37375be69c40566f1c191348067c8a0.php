...
} elseif ($_instance->childHasBeenRendered('EbSO948')) {
    $componentId = $_instance->getRenderedChildComponentId('EbSO948');
    $componentTag = $_instance->getRenderedChildComponentTagName('EbSO948');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EbSO948');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('EbSO948', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\admin\Settings\AppSettings\theme.blade.php ENDPATH**/ ?>