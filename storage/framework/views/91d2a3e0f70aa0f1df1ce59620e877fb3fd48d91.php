...
<script type="text/javascript">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('accountSwapForm').addEventListener('submit', function(e) {
            ...
            // Submit to server
            fetch('<?php echo e(route('exchangenow')); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\user\asset.blade.php ENDPATH**/ ?>