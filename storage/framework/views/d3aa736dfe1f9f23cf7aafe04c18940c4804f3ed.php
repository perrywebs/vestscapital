            ...
            <div class="d-flex align-items-center">
                <div class="avatar-container me-3">
                    <div class="avatar-circle bg-primary bg-gradient text-white">
                        <?php echo e(substr(Auth('admin')->User()->firstName, 0, 1)); ?><?php echo e(substr(Auth('admin')->User()->lastName, 0, 1)); ?>

                    </div>
                    <span class="status-dot bg-success"></span>
                </div>
                <div class="admin-info">
                    <h5 class="mb-1 fw-bold"><?php echo e(Auth('admin')->User()->firstName); ?> <?php echo e(Auth('admin')->User()->lastName); ?></h5>
                    <div class="admin-role">
                        <span class="badge bg-primary-soft text-primary"><?php echo e(Auth('admin')->User()->type); ?></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <ul class="nav-list">
                ...
                <li class="nav-section" @click="activeSection = activeSection === 'users' ? null : 'users'">
                    ...
                    <ul class="nav-section-items" x-show="activeSection === 'users'" x-collapse>
                        <li class="nav-item <?php echo e(request()->routeIs('manageusers') ? 'active' : ''); ?>">
                            <a href="<?php echo e(url('/admin/dashboard/manageusers')); ?>" class="nav-link">
                                <span class="nav-text">All Users</span>
                            </a>
                        </li>
                        <li class="nav-item <?php echo e(request()->routeIs('loginactivity') ? 'active' : ''); ?>">
                            <a href="<?php echo e(url('/admin/dashboard/loginactivity')); ?>" class="nav-link">
                                <span class="nav-text">Login Activity</span>
                            </a>
                        </li>
                        <li class="nav-item <?php echo e(request()->routeIs('user.plans') ? 'active' : ''); ?>">
                            <a href="<?php echo e(url('/admin/dashboard/userplans')); ?>" class="nav-link">
                                <span class="nav-text">User Plans</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(url('/admin/dashboard/user-verification')); ?>" class="nav-link">
                ...
                <li class="nav-section" @click="activeSection = activeSection === 'financial' ? null : 'financial'">
                    ...
                    <ul class="nav-section-items" x-show="activeSection === 'financial'" x-collapse>
                        <li class="nav-item <?php echo e(request()->routeIs('mdeposits') ? 'active' : ''); ?>">
                            <a href="<?php echo e(url('/admin/dashboard/mdeposits')); ?>" class="nav-link">
                                <span class="nav-text">Deposits</span>
                            </a>
                        </li>
                        <li class="nav-item <?php echo e(request()->routeIs('mwithdrawals') ? 'active' : ''); ?>">
                            <a href="<?php echo e(url('/admin/dashboard/mwithdrawals')); ?>" class="nav-link">
                                <span class="nav-text">Withdrawals</span>
                                <span class="nav-badge bg-warning">8</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(url('/admin/dashboard/transactions')); ?>" class="nav-link">
                                <span class="nav-text">Transactions</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(url('/admin/dashboard/payment-methods')); ?>" class="nav-link">
                ...
                <li class="nav-section" @click="activeSection = activeSection === 'trading' ? null : 'trading'">
                    ...
                    <ul class="nav-section-items" x-show="activeSection === 'trading'" x-collapse>
                        <li class="nav-item <?php echo e(request()->routeIs('admin.bots.index') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('admin.bots.index')); ?>" class="nav-link">
                                <span class="nav-text">Trading Bots</span>
                            </a>
                        </li>
                        <li class="nav-item <?php echo e(request()->routeIs('admin.bots.create') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('admin.bots.create')); ?>" class="nav-link">
                                <span class="nav-text">Add New Bot</span>
                            </a>
                        </li>
                        <li class="nav-item <?php echo e(request()->routeIs('admin.bots.dashboard') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('admin.bots.dashboard')); ?>" class="nav-link">
                                <span class="nav-text">Bot Analytics</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(url('/admin/dashboard/trading-history')); ?>" class="nav-link">
                ...
                <li class="nav-section" @click="activeSection = activeSection === 'plans' ? null : 'plans'">
                    ...
                    <ul class="nav-section-items" x-show="activeSection === 'plans'" x-collapse>
                        <li class="nav-item <?php echo e(request()->routeIs('plans') ? 'active' : ''); ?>">
                            <a href="<?php echo e(url('/admin/dashboard/plans')); ?>" class="nav-link">
                                <span class="nav-text">Manage Plans</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(url('/admin/dashboard/newplan')); ?>" class="nav-link">
                ...
                <li class="nav-section" @click="activeSection = activeSection === 'content' ? null : 'content'">
                    ...
                    <ul class="nav-section-items" x-show="activeSection === 'content'" x-collapse>
                        <li class="nav-item <?php echo e(request()->routeIs('frontpage') ? 'active' : ''); ?>">
                            <a href="<?php echo e(url('/admin/dashboard/frontpage')); ?>" class="nav-link">
                                <span class="nav-text">Frontend</span>
                            </a>
                        </li>
                        <li class="nav-item <?php echo e(request()->routeIs('faqmanager') ? 'active' : ''); ?>">
                            <a href="<?php echo e(url('/admin/dashboard/faqmanager')); ?>" class="nav-link">
                                <span class="nav-text">FAQ Manager</span>
                            </a>
                        </li>
                        <li class="nav-item <?php echo e(request()->routeIs('testimonials') ? 'active' : ''); ?>">
                            <a href="<?php echo e(url('/admin/dashboard/testimonials')); ?>" class="nav-link">
                ...
                <li class="nav-section" @click="activeSection = activeSection === 'communications' ? null : 'communications'">
                    ...
                    <ul class="nav-section-items" x-show="activeSection === 'communications'" x-collapse>
                        <li class="nav-item <?php echo e(request()->routeIs('admin.notifications') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('admin.notifications')); ?>" class="nav-link">
                                <span class="nav-text">Notifications</span>
                                <span class="nav-badge bg-primary">12</span>
                            </a>
                        </li>
                        <li class="nav-item <?php echo e(request()->routeIs('admin.send.message.form') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('admin.send.message.form')); ?>" class="nav-link">
                                <span class="nav-text">Send Message</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(url('/admin/dashboard/mailbox')); ?>" class="nav-link">
                ...
                <li class="nav-section" @click="activeSection = activeSection === 'settings' ? null : 'settings'">
                    ...
                    <ul class="nav-section-items" x-show="activeSection === 'settings'" x-collapse>
                        <li class="nav-item <?php echo e(request()->routeIs('appsettingshow') ? 'active' : ''); ?>">
                            <a href="<?php echo e(url('/admin/dashboard/appsettingshow')); ?>" class="nav-link">
                                <span class="nav-text">General Settings</span>
                            </a>
                        </li>
                        <li class="nav-item <?php echo e(request()->routeIs('paymentgtway') ? 'active' : ''); ?>">
                            <a href="<?php echo e(url('/admin/dashboard/paymentgateway')); ?>" class="nav-link">
                                <span class="nav-text">Payment Gateways</span>
                            </a>
                        </li>
                        <li class="nav-item <?php echo e(request()->routeIs('managecryptoasset') ? 'active' : ''); ?>">
                            <a href="<?php echo e(url('/admin/dashboard/managecryptoasset')); ?>" class="nav-link">
                                <span class="nav-text">Crypto Assets</span>
                            </a>
                        </li>
                        <li class="nav-item <?php echo e(request()->routeIs('adminprofile') ? 'active' : ''); ?>">
                            <a href="<?php echo e(url('/admin/dashboard/profile')); ?>" class="nav-link">
                ...
                <li class="nav-section" @click="activeSection = activeSection === 'logs' ? null : 'logs'">
                    ...
                    <ul class="nav-section-items" x-show="activeSection === 'logs'" x-collapse>
                        <li class="nav-item">
                            <a href="<?php echo e(url('/admin/dashboard/activity-log')); ?>" class="nav-link">
                                <span class="nav-text">Activity Log</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(url('/admin/dashboard/system-log')); ?>" class="nav-link">
                                <span class="nav-text">System Log</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(url('/admin/dashboard/reports')); ?>" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('adminlogout')); ?>" class="nav-link text-danger" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        <div class="nav-icon">
...
<?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\admin\sidebar-redesign.blade.php ENDPATH**/ ?>