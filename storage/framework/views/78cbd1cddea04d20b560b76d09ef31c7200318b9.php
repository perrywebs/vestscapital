        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <h1 class="text-4xl font-extrabold tracking-tight text-white sm:text-5xl md:text-6xl mb-4">
                    ...
                    <span class="block text-emerald-400"><?php echo e($settings->site_name); ?></span>
                </h1>
                ...
                <p class="text-base text-gray-300 sm:text-lg lg:text-base xl:text-lg max-w-xl">
                    <?php echo e($settings->site_name); ?> developers have created a unique cryptocurrency robot. It predicts the value of Bitcoin while generating daily profit on trades. The robot is able to benefit at any stage of the market: both growth and decline.
                </p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="mt-4 text-xl text-gray-300 max-w-3xl mx-auto">
                <?php echo e($settings->site_name); ?> ensures that every investor in our company can earn money
            </p>
        </div>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-sm rounded-xl p-6 border border-gray-700">
                        ...
                        <p class="text-gray-300">
                            These commissions are charged by <?php echo e($settings->site_name); ?> for the platform to work. They are not related to the profit received by our investors.
                        </p>
                    </div>
                </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="mt-2 text-base text-gray-300">
                                            <span class="text-emerald-400 font-semibold">0.5%</span> from the received profit by the robot. This commission shows the earnings of the entire <?php echo e($settings->site_name); ?> structure, namely, each employee.
                                        </p>
                                    </div>
                                </div>
            ...
            <div class="relative">
                ...
                <div class="bg-gray-800 bg-opacity-80 backdrop-filter backdrop-blur-sm rounded-xl p-6 border border-gray-700 relative h-full">
                    ...
                    <p class="text-gray-300 text-center">
                        Click the Register button. Fill in your details to create a FREE <?php echo e($settings->site_name); ?> account in seconds.
                    </p>
...
<section class="py-16 bg-gray-900 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative">
        <div class="text-center mb-12">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-emerald-400 mb-4">Best <?php echo e($settings->site_name); ?> Traders</h2>
            <p class="max-w-3xl mx-auto text-gray-300">
                The best cryptocurrency developers work in our company with a wealth of experience and deep understanding of crypto markets. They've elevated <?php echo e($settings->site_name); ?> to world-class development standards.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            ...
            <div class="relative group">
                ...
                <div class="bg-gray-800 bg-opacity-80 backdrop-filter backdrop-blur-sm rounded-xl p-6 border border-gray-700 relative h-full group-hover:border-emerald-500 transition duration-300">
                    ...
                    <p class="text-gray-300 text-center">
                        <?php echo e($settings->site_name); ?>'s team of professionals has created a unique trading robot that generates profit at any market stage: rise or fall.
                    </p>
                </div>
            </div>
            ...
            <div class="relative group">
                ...
                <div class="bg-gray-800 bg-opacity-80 backdrop-filter backdrop-blur-sm rounded-xl p-6 border border-gray-700 relative h-full group-hover:border-emerald-500 transition duration-300">
                    ...
                    <p class="text-gray-300 text-center">
                        The highly professional <?php echo e($settings->site_name); ?> team controls all trading processes around the clock. Watch your capital grow in real time after investing.
                    </p>
                </div>
            </div>
        </div>
        <div class="mt-12 text-center">
            <p class="text-gray-300 mb-6 max-w-3xl mx-auto">
                <?php echo e($settings->site_name); ?> specialists work around the clock to ensure stable platform operation. Our trading robot ensures maximum efficiency and minimizes human factors in trading operations.
            </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div class="bg-gray-800 bg-opacity-80 backdrop-filter backdrop-blur-sm rounded-xl p-6 border border-gray-700 relative">
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="bg-gray-900 bg-opacity-70 rounded-lg p-3 flex items-center justify-center">
                            <img src="<?php echo e(asset('dash/bitcoin-btc-logo.png')); ?>" alt="Bitcoin" class="h-12 w-auto">
                        </div>
                        <!-- Ethereum -->
                        <div class="bg-gray-900 bg-opacity-70 rounded-lg p-3 flex items-center justify-center">
                            <img src="<?php echo e(asset('dash/ethereum-eth-logo.png')); ?>" alt="Ethereum" class="h-12 w-auto">
                        </div>
                        <!-- USDT -->
                        <div class="bg-gray-900 bg-opacity-70 rounded-lg p-3 flex items-center justify-center">
                            <img src="<?php echo e(asset('dash/tether-usdt-logo.png')); ?>" alt="USDT" class="h-12 w-auto">
                        </div>
                        <!-- Credit Card -->
                        <div class="bg-gray-900 bg-opacity-70 rounded-lg p-3 flex items-center justify-center">
            ...
            <div class="order-1 md:order-2">
                ...
                <p class="text-gray-300 mb-4">
                    <?php echo e($settings->site_name); ?> supports a wide range of payment systems for your convenience.
                </p>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\home\investment.blade.php ENDPATH**/ ?>