...
<body x-data="{ darkMode: localStorage.theme === 'dark' || !localStorage.theme, sidebarOpen: false }" :class="{ 'dark': darkMode }" class="dark text-gray-100 bg-gray-900" x-cloak>
    ...
    <nav x-data="{
        ...
        class="bg-white/98 dark:bg-gray-900/98 backdrop-blur-xl border-b border-gray-200/80 dark:border-gray-700/80 sticky top-0 z-50 shadow-sm dark:shadow-gray-900/20"
        x-cloak>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    <div
                        class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 px-4 py-2 rounded-lg border border-blue-100 dark:border-blue-800">
                        <div class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Account Balance
                        </div>
                ...
                <div class="flex items-center space-x-2">
                        ...
                        <div x-show="quickActionsOpen" @click.away="quickActionsOpen = false"
                            ...
                            <div class="p-2">
                                <a href="<?php echo e(route('deposits')); ?>"
                                    class="flex items-center px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-md">
                    ...
                    <div class="relative" x-data="{ notificationOpen: false }">
                        <button @click="notificationOpen = !notificationOpen"
                            ...
                            <?php if($unreadCount > 0): ?>
                                <span
                                    class="absolute -top-1 -right-1 flex items-center justify-center min-w-[18px] h-[18px] text-xs font-medium text-white bg-red-500 rounded-full px-1 border-2 border-white dark:border-gray-900">
                        ...
                        <div x-show="notificationOpen" @click.away="notificationOpen = false"
                            x-transition:enter="transition ease-out duration-200"
                            x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100"
                            class="absolute right-0 sm:right-0 sm:left-auto left-1/2 sm:transform-none transform -translate-x-1/2 mt-2 w-80 max-w-[90vw] bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-20"
                            x-cloak>
                            <div
                                ...
                                <h3 class="text-sm font-semibold text-gray-900 dark:text-white">
                                    ...
                                    <?php if($unreadCount > 0): ?>
                                        <span
                                            class="ml-2 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-100 bg-red-500 rounded-full">
                            ...
                            <div class="max-h-[60vh] overflow-y-auto">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <a href="<?php echo e(route('notifications.show', $notification->id)); ?>"
                                        ...
                                        <div
                                            class="px-4 py-3 <?php echo e(!$notification->is_read ? 'bg-blue-50 dark:bg-blue-900/10' : ''); ?>">
                                            <div class="flex items-start">
                                                <div class="flex-shrink-0 mt-0.5">
                                                    <span
                                                        class="flex h-8 w-8 rounded-full items-center justify-center <?php echo e($notification->type === 'warning' ? 'bg-yellow-100 text-yellow-600 dark:bg-yellow-900/20 dark:text-yellow-500' : ($notification->type === 'success' ? 'bg-green-100 text-green-600 dark:bg-green-900/20 dark:text-green-500' : ($notification->type === 'danger' ? 'bg-red-100 text-red-600 dark:bg-red-900/20 dark:text-red-500' : 'bg-blue-100 text-blue-600 dark:bg-blue-900/20 dark:text-blue-500'))); ?>">
                                                ...
                                                <div class="ml-3 w-0 flex-1">
                                                    <p
                                                        class="text-sm font-medium text-gray-900 dark:text-white <?php echo e(!$notification->is_read ? 'font-semibold' : ''); ?>">
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <div class="py-8 text-center">
                                        <div
                                            class="inline-flex h-14 w-14 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800 text-gray-400 dark:text-gray-500 mb-4">
                                            <i data-lucide="bell-off" class="h-6 w-6"></i>
                                        </div>
                                        <p class="text-sm text-gray-600 dark:text-gray-400">No notifications</p>
                                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-500">We'll notify you when
                                            something arrives</p>
                                    </div>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="relative" x-data="{ dropdownOpen: false }">
                        <button @click="dropdownOpen = !dropdownOpen"
                            ...
                            <div class="flex items-center space-x-2">
                                <div
                                    class="w-8 h-8 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 flex items-center justify-center text-white text-sm font-medium">
                        ...
                        <div x-show="dropdownOpen" @click.away="dropdownOpen = false"
                            ...
                            <div class="p-4 border-b border-gray-200 dark:border-gray-700">
                                <div class="flex items-center space-x-3">
                                    <div
                                        class="w-12 h-12 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 flex items-center justify-center text-white text-lg font-medium">
                                        <?php echo e(Str::upper(substr(Auth::user()->name, 0, 1))); ?>
                            ...
                            <div class="p-2">
                                ...
                                <form method="POST" action="<?php echo e(route('logout')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit"
                                        class="w-full flex items-center px-3 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md">
            ...
            <div class="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20"
                ...
                <div class="space-y-2">
                    <coingecko-coin-price-marquee-widget coin-ids="bitcoin,ethereum,eos,ripple,litecoin"
                        currency="usd" background-color="transparent" locale="en" font-color="#333">
                        ...
                        <?php if(isset($settings->enable_kyc) && $settings->enable_kyc === 'yes'): ?>
                            <li x-data="{ kycOpen: false }" x-cloak>
                                <?php if(Auth::user()->account_verify === 'Verified'): ?>
                                    <!-- Verified Status -->
                                    <div
                                        class="flex items-center px-3 py-2 text-gray-700 dark:text-gray-200 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-800">
                                        <i data-lucide="shield-check"
                                            class="w-5 h-5 mr-3 text-green-600 dark:text-green-400"></i>
                                        <span class="font-medium text-green-700 dark:text-green-300">Account
                                            Verified</span>
                                    </div>
                                <?php else: ?>
                                    <!-- KYC Dropdown -->
                                    <div class="relative">
                                        ...
                                        <div x-show="kycOpen" x-transition:enter="transition ease-out duration-200"
                                            ...
                                            <?php if(Auth::user()->account_verify === 'Under review'): ?>
                                                ...
                                                <div
                                                    class="flex items-center text-xs text-yellow-600 dark:text-yellow-400">
                    ...
                    <ul class="space-y-1">
                        <li>
                            <a href="<?php echo e(route('referuser')); ?>"
                                ...
                                Referral Program
                                <span
                                    class="ml-auto px-2 py-0.5 text-xs font-medium text-white bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-full"><?php echo e($settings->referral_commission); ?>%</span>
                                <div
    ...
    <div class="fixed bottom-0 w-full z-30 md:hidden" x-data="{ fabOpen: false }" x-cloak>
        ...
        <div
            ...
            <a href="<?php echo e(route('deposits')); ?>" class="group flex flex-col items-center relative">
                <div
           ...
           transition-colors duration-300"></i>
            ...
            <a href="<?php echo e(route('profile')); ?>" class="group flex flex-col items-center relative">
                <div
                    class="p-2 rounded-xl transition-all duration-300 ease-out
            ...
            <div
                ...
                <div class="space-y-2">
                    ...
                    <a href="#"
                        ...
                        <span
                            class="ml-auto text-xs font-bold text-orange-400">+<?php echo e($settings->referral_commission); ?>%</span>
                    </a>
...
<?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views/layouts/dasht.blade.php ENDPATH**/ ?>