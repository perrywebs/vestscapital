                    ...
                    <div class="p-4 sm:p-6 space-y-6 sm:space-y-8">
                                        ...
                                        <div class="flex flex-col sm:flex-row">
                                            ...
                                            <button type="button"
                                                ...
                                                <span x-text="copied ? 'Copied!' : 'Copy'"
                                                    class="text-xs sm:text-sm font-medium"></span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="pt-4 sm:pt-6">
                            <button type="submit" :disabled="!fileName || isSubmitting"
                                @click="if (!fileName || isSubmitting) $event.preventDefault()"
                                class="w-full relative group overflow-hidden"
                                :class="(!fileName || isSubmitting) ?
                                'opacity-50 cursor-not-allowed' :
                                'hover:scale-[1.02] active:scale-[0.98]'">
                                <div class="absolute inset-0 bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl blur-lg transition-opacity duration-200"
                                    :class="isSubmitting ? 'opacity-30' : 'opacity-50 group-hover:opacity-75'"></div>
                                ...
                                <div
                                    ...
                                    <template x-if="isSubmitting">
                                        <div class="flex items-center justify-center gap-2 sm:gap-3">
                                            <svg class="animate-spin w-4 h-4 sm:w-5 sm:h-5"
    ...
    <script>
        function paymentHandler() {
            return {
                ...
                submitForm(event) {
                    // Prevent any second submission
                    if (this.isSubmitting) {
                        event.preventDefault();
                        return false;
                    }

                    // Don't submit without a file
                    if (!this.fileName) {
                        event.preventDefault();
                        return false;
                    }
                    ...
                    // Allow the browser to submit normally
                    return true;
                },
