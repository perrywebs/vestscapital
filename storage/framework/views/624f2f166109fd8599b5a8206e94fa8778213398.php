                                ...
                                <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <?php if(isset($plan->puser->currency) && $plan->puser->currency != null): ?>
                                            <td>
                                                <?php echo e($plan->puser->currency ?? 'N/A'); ?><?php echo e($plan->profit_earned ? $plan->profit_earned : '0'); ?>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="<?php echo e(route('user.plans', $plan->puser->id ?? '1')); ?>">More
                                                        actions</a>
                                                </div>
                                            </div>
                                        </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views/admin/Plans/activeinv.blade.php ENDPATH**/ ?>