        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400"><?php echo e($plan->name); ?></span>
                </div>
            </li>
        </ol>
    </nav>
...
<?php endif; ?>
    ...
    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-2xl p-8 mb-8 animate-fade-in shadow-lg">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <?php endif; ?>
                <h1 class="text-3xl md:text-4xl font-bold mb-2"><?php echo e($plan->name); ?></h1>
                <?php if($plan->description): ?>
                <p class="text-indigo-100 text-lg mb-4"><?php echo e($plan->description); ?></p>
                <?php endif; ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-900 dark:text-white">
                                <?php echo e(Auth::user()->currency); ?><?php echo e(number_format($plan->min_price, 2)); ?> - <?php echo e(Auth::user()->currency); ?><?php echo e(number_format($plan->max_price, 2)); ?>
                        ...
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-900 dark:text-white">
                                <?php echo e($plan->min_return); ?>% - <?php echo e($plan->max_return); ?>%
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-900 dark:text-white">
                                <?php echo e($plan->duration); ?> <?php echo e(Str::plural($plan->duration_type, $plan->duration)); ?>
                        ...
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-900 dark:text-white">
                                <?php echo e(ucfirst($plan->payout_interval)); ?>

                            </p>
                        </div>

                        <?php if($plan->allow_compounding): ?>
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-900 dark:text-white flex items-center">
                                ...
                                Available
                                <?php if($plan->compounding_percentage): ?>
                                (Up to <?php echo e($plan->compounding_percentage); ?>%)
                                <?php endif; ?>
                            </p>
                        </div>
                        <?php endif; ?>

                        <?php if($plan->bonus_percentage > 0): ?>
                        <div>
                            ...
                            <p class="text-lg font-semibold text-green-600 dark:text-green-500">
                                <?php echo e($plan->bonus_percentage); ?>% on investment
                            </p>
                        </div>
                        <?php endif; ?>
                    </div>
            ...
            <!-- Plan Features -->
            <?php if(count($plan->planFeatures) > 0): ?>
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">
                                        <?php echo e(Auth::user()->currency); ?><?php echo e(number_format($example['investment'], 2)); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">
                                        <?php echo e(Auth::user()->currency); ?><?php echo e(number_format($example['return'], 2)); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-green-600 dark:text-green-500 font-medium">
                                        +<?php echo e(Auth::user()->currency); ?><?php echo e(number_format($example['profit'], 2)); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">
                                        <?php echo e(number_format(($example['profit'] / $example['investment']) * 100, 2)); ?>%
                                    </td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
        ...
        <div class="lg:col-span-1 animate-fade-in animate-fade-in-delay-3">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden sticky top-24">
                ...
                <div class="p-6">
                    <form action="<?php echo e(route('user.plans.purchase')); ?>" method="POST" id="purchaseForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="amount" name="amount"
                                    min="<?php echo e($plan->min_price); ?>" max="<?php echo e($plan->max_price); ?>" step="0.01"
                                    value="<?php echo e($plan->min_price); ?>"
                            ...
                            <div class="flex justify-between mt-1 text-xs text-gray-500 dark:text-gray-400">
                                <span>Min: <?php echo e(Auth::user()->currency); ?><?php echo e(number_format($plan->min_price, 2)); ?></span>
                                <span>Max: <?php echo e(Auth::user()->currency); ?><?php echo e(number_format($plan->max_price, 2)); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div id="compoundingOptions" class="hidden p-4 bg-gray-50 dark:bg-gray-700 rounded-lg mb-2">
                                ...
                                <input type="range" id="compounding_percentage" name="compounding_percentage"
                                    min="10" max="<?php echo e($plan->compounding_percentage ?? 100); ?>" step="10" value="50"
                                ...
                                <div class="flex justify-between mt-1 text-xs text-gray-600 dark:text-gray-400">
                                    ...
                                    <span><?php echo e($plan->compounding_percentage ?? 100); ?>%</span>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg mb-6">
                            <div>
                                ...
                                <span class="text-lg font-bold text-gray-800 dark:text-white"><?php echo e(Auth::user()->currency); ?><?php echo e(number_format(Auth::user()->account_bal, 2)); ?></span>
                            </div>
                            <a href="<?php echo e(route('deposit')); ?>" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 text-sm font-medium">
                                Add Funds
                            </a>
                        </div>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\user\plan\show.blade.php ENDPATH**/ ?>