...
<div class="sidenav" id="sidenav-main">
        ...
        <div>
            ...
            <div class="mt-4">
                ...
                <a href="#" class="shadow btn btn-sm btn-white btn-icon rounded-pill hover-translate-y-n3">
                    ...
                    <span
                        class="btn-inner--text"><?php echo e(Auth::user()->currency); ?><?php echo e(number_format(Auth::user()->account_bal, 2, '.', ',')); ?></span>
                </a>
            </div>
        </div>
        <!-- User info -->
    ...
    <div class="clearfix nav-application">
        ...
        <a href="<?php echo e(route('notifications')); ?>"
            class="text-sm btn btn-square <?php echo e(request()->routeIs('notifications') ? 'active' : ''); ?>">
            <span class="btn-inner--icon d-block">
                <i class="fas fa-bell fa-2x"></i>
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('user.notifications-count')->html();
} elseif ($_instance->childHasBeenRendered('F291Kkw')) {
    $componentId = $_instance->getRenderedChildComponentId('F291Kkw');
    $componentTag = $_instance->getRenderedChildComponentTagName('F291Kkw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('F291Kkw');
} else {
    $response = \Livewire\Livewire::mount('user.notifications-count');
    $html = $response->html();
    $_instance->logRenderedChild('F291Kkw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </span>
...
<?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\user\sidebar.blade.php ENDPATH**/ ?>