                ...
                <div class="relative bg-white dark:bg-slate-800 rounded-2xl p-8 border border-slate-200 dark:border-slate-700">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="text-right">
                            <div class="text-3xl font-bold text-slate-900 dark:text-white"><?php echo e(count($copytradings)); ?></div>
            ...
            <div class="group relative">
                ...
                <div class="relative bg-white dark:bg-slate-800 rounded-2xl p-8 border border-slate-200 dark:border-slate-700">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="text-right">
                            <div class="text-3xl font-bold text-slate-900 dark:text-white"><?php echo e($settings->currency); ?>50</div>
...
<?php endif; ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" x-data="{ hoveredCard: null }">
            <?php $__currentLoopData = $copytradings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $copytrading): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="group relative"
                 x-on:mouseenter="hoveredCard = <?php echo e($copytrading->id); ?>"
                    ...
                    <div class="flex justify-center -mt-16 mb-4 relative z-20">
                        <div class="relative">
                            <div class="w-32 h-32 rounded-full overflow-hidden border-4 border-white dark:border-slate-700 shadow-2xl bg-white group-hover:scale-105 transition-transform duration-300">
                                <img src="<?php echo e(asset('/storage/app/public/photos/'.$copytrading->photo)); ?>"
                                     class="w-full h-full object-cover"
                                     alt="<?php echo e($copytrading->name); ?>">
                            </div>
                            <!-- Verified Badge -->
                    ...
                    <div class="pb-6 px-6">
                        ...
                        <div class="text-center mb-6">
                            <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2">
                                <?php echo e($copytrading->name); ?>

                            </h3>
                            <div class="flex items-center justify-center gap-1">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <?php if($i <= $copytrading->rating): ?>
                                        <i data-lucide="star" class="w-4 h-4 text-yellow-400 fill-yellow-400"></i>
                                    <?php else: ?>
                                        <i data-lucide="star" class="w-4 h-4 text-slate-300 dark:text-slate-600"></i>
                                    <?php endif; ?>
                                <?php endfor; ?>
                                <span class="text-sm text-slate-500 dark:text-slate-400 ml-2">(<?php echo e($copytrading->rating); ?>/5)</span>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-6">
                            <div class="p-3 bg-slate-50 dark:bg-slate-700/50 rounded-xl">
                                ...
                                <div class="text-lg font-bold text-slate-900 dark:text-white"><?php echo e(number_format($copytrading->followers)); ?></div>
                            </div>
                            ...
                            <div class="p-3 bg-slate-50 dark:bg-slate-700/50 rounded-xl">
                                ...
                                <div class="text-lg font-bold text-green-600 dark:text-green-400"><?php echo e($copytrading->equity); ?>%</div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-3 mb-6">
                            <div class="flex items-center justify-between py-2">
                                ...
                                <span class="text-sm font-semibold text-slate-900 dark:text-white"><?php echo e($settings->currency); ?><?php echo e(number_format($copytrading->price)); ?></span>
                            </div>
                            <div class="flex items-center justify-between py-2">
                                <span class="text-sm text-slate-600 dark:text-slate-400">Total Profit</span>
                                <span class="text-sm font-semibold text-green-600 dark:text-green-400"><?php echo e($settings->currency); ?><?php echo e(number_format($copytrading->total_profit)); ?></span>
                            </div>
                        </div>

                        <!-- Action Button -->
                                                <?php if(in_array($copytrading->id, $userCopyTrades)): ?>
                        <form method="post" action="<?php echo e(route('cancelcopytrade')); ?>">
                            <?php echo csrf_field(); ?>
                            <button type="submit"
                        ...
                        <?php else: ?>
                        <button onclick="openInvestModal(<?php echo e($copytrading->id); ?>, '<?php echo e($copytrading->name); ?>', <?php echo e($copytrading->price); ?>)"
    ...
    function openInvestModal(expertId, expertName, minAmount) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.method = 'POST';
                form.action = '<?php echo e(route("joincopytrade")); ?>';
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\user\mcopytradings.blade.php ENDPATH**/ ?>