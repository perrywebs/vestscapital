<?php $__env->startSection('title', 'Invest in Plan'); ?>
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="<?php echo e(route('user.plans.index')); ?>" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Investment Plans</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="<?php echo e(route('user.plans.show', $plan->id)); ?>" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white"><?php echo e($plan->name); ?></a>
                    </div>
                </li>
        ...
        <h1 class="text-3xl font-bold text-gray-800 dark:text-white mb-2">Invest in <?php echo e($plan->name); ?></h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 animate-fade-in stagger-item">
                <form action="<?php echo e(route('user.plans.process', $plan->id)); ?>" method="POST" id="investmentForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex items-center mb-2">
                                <span class="text-gray-500 dark:text-gray-400"><?php echo e(Auth::user()->currency); ?><?php echo e(number_format($plan->min_amount, 2)); ?></span>
                                <div class="mx-4 flex-1">
                                    <input type="range" id="amountSlider" class="slider" min="<?php echo e($plan->min_amount); ?>" max="<?php echo e($plan->max_amount); ?>" step="1" value="<?php echo e(old('amount', $plan->min_amount)); ?>">
                                </div>
                                <span class="text-gray-500 dark:text-gray-400"><?php echo e(Auth::user()->currency); ?><?php echo e(number_format($plan->max_amount, 2)); ?></span>
                            </div>
                            <div class="mt-2">
                                <div class="relative">
                                    ...
                                    <input type="number" id="amount" name="amount" value="<?php echo e(old('amount', $plan->min_amount)); ?>" min="<?php echo e($plan->min_amount); ?>" max="<?php echo e($plan->max_amount); ?>" step="0.01" required class="pl-10 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-800 dark:text-white sm:text-sm">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-8">
                        ...
                        <div>
                            ...
                            <input type="text" id="referral_code" name="referral_code" value="<?php echo e(old('referral_code')); ?>" class="block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-800 dark:text-white sm:text-sm" placeholder="Enter referral code">
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                If someone referred you, enter their code here. They will receive a <?php echo e($plan->referral_bonus); ?>% bonus.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 text-sm">
                                <label for="terms" class="text-gray-700 dark:text-gray-300">I agree to the <a href="<?php echo e(route('terms')); ?>" class="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">Terms of Service</a> and <a href="<?php echo e(route('privacy')); ?>" class="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">Privacy Policy</a></label>
                            </div>
                        </div>
        ...
        <div>
            <div class="sticky top-6">
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6 animate-fade-in stagger-item">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium text-gray-900 dark:text-white" id="summaryAmount"><?php echo e(Auth::user()->currency); ?><?php echo e(number_format($plan->min_amount, 2)); ?></span>
                        </div>

                        <div class="flex justify-between">
                            <span class="text-gray-600 dark:text-gray-300">Return Rate:</span>
                            <span class="font-medium text-green-600 dark:text-green-500"><?php echo e($plan->expected_return); ?>% / <?php echo e($plan->return_interval); ?></span>
                        </div>

                        <div class="flex justify-between">
                            <span class="text-gray-600 dark:text-gray-300">Duration:</span>
                            <span class="font-medium text-gray-900 dark:text-white"><?php echo e($plan->duration); ?> <?php echo e(Str::plural('Day', $plan->duration)); ?></span>
                        </div>

                        <div class="flex justify-between">
                            <span class="text-gray-600 dark:text-gray-300">Total Return:</span>
                            <span class="font-medium text-green-600 dark:text-green-500" id="summaryReturn"><?php echo e(Auth::user()->currency); ?>0.00</span>
                        </div>

                        <div class="flex justify-between">
                            <span class="text-gray-600 dark:text-gray-300">Maturity Date:</span>
                            <span class="font-medium text-gray-900 dark:text-white" id="maturityDate"><?php echo e(now()->addDays($plan->duration)->format('M d, Y')); ?></span>
                        </div>

                        <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex justify-between text-lg">
                                <span class="font-medium text-gray-900 dark:text-white">Final Amount:</span>
                                <span class="font-bold text-gray-900 dark:text-white" id="summaryFinal"><?php echo e(Auth::user()->currency); ?>0.00</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-indigo-50 dark:bg-indigo-900/30 rounded-xl p-6 animate-fade-in stagger-item">
                    ...
                    <a href="<?php echo e(route('user.support')); ?>" class="inline-flex items-center text-sm font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">
                        Contact Support
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const currency = "<?php echo e(Auth::user()->currency); ?>";
    const expectedReturn = <?php echo e($plan->expected_return); ?>;
    const duration = <?php echo e($plan->duration); ?>;
    const returnInterval = "<?php echo e($plan->return_interval); ?>";
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\user\plan\invest.blade.php ENDPATH**/ ?>