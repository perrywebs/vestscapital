                ...
                <div class="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm ring-1 ring-gray-200 dark:ring-gray-800">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(Auth::user()->signals ?? 'No Active Plan'); ?></p>
                        </div>
                        <?php if(Auth::user()->signals): ?>
                        <div class="ml-4">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm ring-1 ring-gray-200 dark:ring-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e(count($signals)); ?></p>
                    </div>
                    <div class="p-3 bg-blue-100 dark:bg-blue-900/30 rounded-xl">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-green-600 dark:text-green-400">
                            <?php echo e($signals->where('status', 'ongoing')->count()); ?>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-purple-600 dark:text-purple-400">
                            <?php echo e(Auth::user()->currency); ?><?php echo e(number_format($signals->sum('amount'), 2)); ?>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($signal->asset); ?></span>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white">
                                <?php echo e(Auth::user()->currency); ?><?php echo e(number_format($signal->amount, 2)); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300">
                                    ...
                                    <?php echo e(ucfirst($signal->status)); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400">
                                <?php echo e(\Carbon\Carbon::parse($signal->created_at)->format('M d, Y H:i')); ?>
            ...
            <div class="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm ring-1 ring-gray-200 dark:ring-gray-800">
                ...
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white"><?php echo e($signal->asset); ?></h3>
                    </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-900 dark:text-white"><?php echo e(Auth::user()->currency); ?><?php echo e(number_format($signal->amount, 2)); ?></p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-900 dark:text-white"><?php echo e(\Carbon\Carbon::parse($signal->created_at)->format('M d, Y')); ?></p>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\user\msignals.blade.php ENDPATH**/ ?>