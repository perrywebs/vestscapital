    ...
    <div class="max-w-4xl">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">Update the details for <?php echo e($expert->name); ?></p>
            </div>

            <form action="<?php echo e(route('admin.copy.update', $expert->id)); ?>" method="POST" enctype="multipart/form-data" class="p-6">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="name" 
                                   name="name" 
                                   value="<?php echo e(old('name', $expert->name)); ?>"
                                   required
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="tag" 
                                   name="tag" 
                                   value="<?php echo e(old('tag', $expert->tag)); ?>"
                                   class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-4">
                                <div id="photo-preview" class="w-20 h-20 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center overflow-hidden">
                                    <?php if($expert->photo): ?>
                                        <img src="<?php echo e(asset('storage/' . $expert->photo)); ?>" class="w-full h-full object-cover rounded-full" alt="<?php echo e($expert->name); ?>">
                                    <?php else: ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea id="description" 
                                      ...
                                      rows="4"
                                      class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                                      placeholder="Brief description of the expert's trading style and expertise..."><?php echo e(old('description', $expert->description)); ?></textarea>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="rating" 
                                ...
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <option value="<?php echo e($i); ?>" <?php echo e(old('rating', $expert->rating) == $i ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="win_rate" 
                                   name="win_rate" 
                                   value="<?php echo e(old('win_rate', $expert->win_rate)); ?>"
                                   min="0" 
                                   max="100" 
                                   required
                                   class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="total_profit" 
                                   name="total_profit" 
                                   value="<?php echo e(old('total_profit', $expert->total_profit)); ?>"
                                   step="0.01" 
                                   min="0" 
                                   required
                                   class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="equity" 
                                   name="equity" 
                                   value="<?php echo e(old('equity', $expert->equity)); ?>"
                                   step="0.01" 
                                   min="0" 
                                   required
                                   class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="total_trades" 
                                   name="total_trades" 
                                   value="<?php echo e(old('total_trades', $expert->total_trades)); ?>"
                                   min="0" 
                                   required
                                   class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="price" 
                                   name="price" 
                                   value="<?php echo e(old('price', $expert->price)); ?>"
                                   step="0.01" 
                                   min="0" 
                                   required
                                   class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="followers" 
                                   name="followers" 
                                   value="<?php echo e(old('followers', $expert->followers)); ?>"
                                   min="0" 
                                   required
                                   class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                                   placeholder="e.g., 150">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select id="status" 
                                ...
                                <option value="active" <?php echo e(old('status', $expert->status) == 'active' ? 'selected' : ''); ?>>Active</option>
                                <option value="inactive" <?php echo e(old('status', $expert->status) == 'inactive' ? 'selected' : ''); ?>>Inactive</option>
                            </select>
                ...
                <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                            ...
                            <div class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($expert->activeCopiers()->count()); ?></div>
                        </div>
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                            <div class="text-sm text-gray-600 dark:text-gray-400">Total Copiers</div>
                            <div class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($expert->copiers()->count()); ?></div>
                        </div>
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                            <div class="text-sm text-gray-600 dark:text-gray-400">Copy Volume</div>
                            <div class="text-2xl font-bold text-gray-900 dark:text-white">$<?php echo e(number_format($expert->copiers()->sum('amount'), 2)); ?></div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\admin\copy\edit.blade.php ENDPATH**/ ?>