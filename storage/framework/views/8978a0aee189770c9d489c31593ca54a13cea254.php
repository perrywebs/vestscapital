    ...
    <?php else: ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-gray-900 rounded-2xl p-6 border border-gray-700">
                <div class="flex items-start justify-between mb-6">
                    <div>
                        <div class="flex items-center gap-3 mb-2">
                            <h3 class="text-xl font-bold text-white"><?php echo e($subscription->subscription); ?> Subscription</h3>
                        ...
                        <div class="flex items-center gap-2 text-2xl font-bold text-blue-400">
                            <span><?php echo e($settings->currency); ?><?php echo e(number_format($subscription->amount_paid, 2)); ?></span>
                        </div>
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-white font-semibold text-sm">
                            <?php echo e(\Carbon\Carbon::parse($subscription->expired_at)->format('M d, Y')); ?>

                        </p>
                        <p class="text-gray-400 text-xs">
                            <?php echo e(\Carbon\Carbon::parse($subscription->expired_at)->diffForHumans()); ?>
                ...
                <?php if(now()->greaterThanOrEqualTo(\Carbon\Carbon::parse($subscription->reminded_at)) or now()->greaterThanOrEqualTo(\Carbon\Carbon::parse($subscription->expired_at))): ?>
                    <!-- Renewal Section -->
                                ...
                                >
                                    <span class="flex items-center gap-2">
                                        ...
                                        <?php if($subscription->subscription == 'Monthly'): ?>
                                            <?php echo e($settings->currency); ?><?php echo e(number_format($set->signal_monthly_fee, 2)); ?>

                                        <?php elseif($subscription->subscription == 'Quarterly'): ?>
                                            <?php echo e($settings->currency); ?><?php echo e(number_format($set->signal_quarterly_fee, 2)); ?>

                                        <?php else: ?>
                                            <?php echo e($settings->currency); ?><?php echo e(number_format($set->signal_yearly_fee, 2)); ?>
...
} elseif ($_instance->childHasBeenRendered('jIygjS7')) {
    $componentId = $_instance->getRenderedChildComponentId('jIygjS7');
    $componentTag = $_instance->getRenderedChildComponentTagName('jIygjS7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jIygjS7');
} else {
    $response = \Livewire\Livewire::mount('user.subscribe-to-signal', []);
    $html = $response->html();
    $_instance->logRenderedChild('jIygjS7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
    ...
    <?php if($subscription && (now()->greaterThanOrEqualTo(\Carbon\Carbon::parse($subscription->reminded_at)) or now()->greaterThanOrEqualTo(\Carbon\Carbon::parse($subscription->expired_at)))): ?>
        <!-- Renewal Modal -->
                ...
                <div class="p-6">
                    <div class="text-center mb-6">
                        ...
                        <p class="text-gray-400 text-sm">
                            ...
                            <?php endif; ?>
                            will be deducted from your account balance to renew your <?php echo e($subscription->subscription); ?> subscription.
                        </p>
                    </div>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\user\signals\subscribe.blade.php ENDPATH**/ ?>