    ...
    function getcurrbalance() {
        ...
        usdelement.forEach(element => {
            ...
            $.ajax({
                ...
                type: 'GET',
                success: function(response) {
                    element.textContent  = "<?php echo e(Auth::user()->currency); ?>" + response.data;
                },
...
<?php /**PATH C:\Users\LENOVO\Herd\vestscapital\resources\views\user\exchangescript.blade.php ENDPATH**/ ?>