            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 group">
                        <img src="{{ URL('storage/app/public/' . $settings->logo) }}" class="h-8 w-auto" alt="Logo" />
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-start">
                                                ...
                                                <div class="ml-3 w-0 flex-1">
                                                    <p
                                                        class="text-sm font-medium text-gray-900 dark:text-white {{ !$notification->is_read ? 'font-semibold' : '' }}">
                                                        {{ $notification->title }}
                                                    </p>
                                                    <p
                    ...
                    <ul class="space-y-1">
                        <li>
                            <a href="{{ route('referuser') }}"
                                ...
                                Referral Program
                                <span
                                    class="ml-auto px-2 py-0.5 text-xs font-medium text-white bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-full">{{ $settings->referral_commission }}%</span>
                                <div
                                    class="hidden group-hover:block absolute left-full ml-2 px-2 py-1 bg-gray-900 text-xs text-white rounded whitespace-nowrap">
        ...
        <div x-show="fabOpen" @click.away="fabOpen = false"
          ...
          <span class="ml-auto text-xs font-bold text-indigo-400">Swap</span>
                    ...
                    <a href="#"
                        ...
                        <span
                            class="ml-auto text-xs font-bold text-orange-400">+{{ $settings->referral_commission }}%</span>
                    </a>
