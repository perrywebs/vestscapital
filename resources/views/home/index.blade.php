                ...
                <div class="col-xl-5">
                    ...
                    <div class="hero-support-box wow fadeInUp">
                        ...
                        <div class="hero-support-box-content">
                            ...
                            <ul>
                                <li>Email Us: <a href="mailto:{{ $settings->contact_email }}">{{ $settings->contact_email }}</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- Hero Info Box End -->
                                ...
                                <div class="swiper-slide">
                                    <div class="project-item">
                                        ...
                                        <div class="project-item-content">
                                            ...
                                            <h2><a href="{{ route('register') }}">Startup financial strategy development</a>
                                            </h2>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="project-item">
                                        ...
                                        <div class="project-item-content">
                                            ...
                                            <h2><a href="{{ route('register') }}">Financial Risk Analysis and Protection</a>
                                            </h2>
                                        </div>
                                        <!-- Project Item Content End -->
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="project-item">
                                        ...
                                        <div class="project-item-content">
                                            ...
                                            <h2><a href="{{ route('register') }}">Complete Financial Restructuring</a></h2>
                                        </div>
                                        <!-- Project Item Content End -->
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="project-item">
                                        ...
                                        <div class="project-item-content">
                                            ...
                                            <h2><a href="{{ route('register') }}">Risk Assessment & Financial Protection</a>
                                            </h2>
                                        </div>
                                        <!-- Project Item Content End -->
                                    </div>
