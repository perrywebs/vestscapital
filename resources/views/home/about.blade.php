            ...
            <div class="row section-row">
                <div class="col-lg-12">
                    ...
                    <div class="section-title section-title-center">
                        ...
                        <h2 class="text-anime-style-3" data-cursor="-opaque">Affordable financial solutions</h2>
                        <p class="wow fadeInUp" data-wow-delay="0.2s">Explore our customized packages designed to provide
                            value-driven financial consulting and support for businesses of all sizes.</p>
                    </div>
                    <!-- Section Title End -->
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="our-pricing-box wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="our-pricing-swich form-check form-switch">
                            ...
                            <label class="form-check-label" for="planToggle" id="toggleLabelYearly">Yearly</label>
                        </div>
                                    ...
                                    <div class="pricing-item">
                                        ...
                                        <div class="pricing-item-header">
                                            ...
                                            <div class="pricing-item-content">
                                                <h2>Basic Plan</h2>
                                                <p>Ideal for small business & individuals</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="pricing-item-body">
                                            ...
                                            <div class="pricing-item-list">
                                                ...
                                                <ul>
                                                    <li>Multi Expert Consulting Team</li>
                                                    <li>24/7 Priority Support and Services</li>
                                                    <li>Corporate Strategy, Transformation</li>
                                                    <li>Email Support & Guidance</li>
                                                </ul>
                                            </div>
                        ...
                        <!-- Pricing Tab Item Start -->
                        <div class="pricing-tab-item d-none" id="yearly">
                            <div class="row">
                                <div class="col-xl-4 col-md-6">
                                    <!-- Pricing Item Start -->
                                    <div class="pricing-item">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="section-footer-text section-satisfy-img wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <!-- Satisfy Client Images End -->
                        <p>Let's make something great work together. <a href="{{ route('register') }}">Meet with our team</a></p>
                    </div>
                    <!-- Section Footer Text End -->
                </div>
            </div>
