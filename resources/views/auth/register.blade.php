                ...
                <div class="bg-gray-900 border border-gray-700 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 shadow-2xl"
                    ...
                    <div class="text-center mb-8">
                        ...
                        <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-2">
                            Join <span
                                class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">{{ $settings->site_name }}</span>
                        </h1>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <input type="text" name="username" id="username" value="{{ old('username') }}"
                                            required
                                            class="block w-full rounded-xl border {{ $errors->has('username') ? 'border-red-500' : 'border-gray-600' }} bg-gray-900 pl-12 pr-4 py-4 text-white placeholder-gray-400 focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 focus:bg-gray-800 transition-all duration-200 text-sm font-bold"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <input type="text" name="name" id="name" value="{{ old('name') }}"
                                            required
                                            class="block w-full rounded-xl border {{ $errors->has('name') ? 'border-red-500' : 'border-gray-600' }} bg-gray-900 pl-12 pr-4 py-4 text-white placeholder-gray-400 focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 focus:bg-gray-800 transition-all duration-200 text-sm font-bold"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <input type="email" name="email" id="email" value="{{ old('email') }}"
                                            required
                                            class="block w-full rounded-xl border {{ $errors->has('email') ? 'border-red-500' : 'border-gray-600' }} bg-gray-900 pl-12 pr-4 py-4 text-white placeholder-gray-400 focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 focus:bg-gray-800 transition-all duration-200 text-sm font-bold"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <input type="tel" name="phone" id="phone" value="{{ old('phone') }}"
                                            required
                                            class="block w-full rounded-xl border {{ $errors->has('phone') ? 'border-red-500' : 'border-gray-600' }} bg-gray-900 pl-12 pr-4 py-4 text-white placeholder-gray-400 focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 focus:bg-gray-800 transition-all duration-200 text-sm font-bold"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <select name="country" id="country" required @change="updateCurrency($event)"
                                            class="block w-full rounded-xl border {{ $errors->has('country') ? 'border-red-500' : 'border-gray-600' }} bg-gray-900 pl-12 pr-8 py-4 text-white focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 focus:bg-gray-800 transition-all duration-200 text-sm font-bold appearance-none">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <select name="currency" id="currency" required
                                            class="block w-full rounded-xl border {{ $errors->has('currency') ? 'border-red-500' : 'border-gray-600' }} bg-gray-900 pl-12 pr-8 py-4 text-white focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 focus:bg-gray-800 transition-all duration-200 text-sm font-bold appearance-none">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <input type="password" name="password" id="password" required
                                            class="block w-full rounded-xl border {{ $errors->has('password') ? 'border-red-500' : 'border-gray-600' }} bg-gray-900 pl-12 pr-4 py-4 text-white placeholder-gray-400 focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 focus:bg-gray-800 transition-all duration-200 text-sm font-bold"
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="relative group">
                                            ...
                                            <input type="text" name="ref_by" id="ref_by"
                                                value="{{ old('ref_by') ?? session('ref_by') }}"
            ...
            function registrationForm() {
                return {
                    ...
                    updateCurrency(event) {
                        ...
                        const currencyMap = @json($countryCurrencies);
