 ...
 <div id="Nostrades" class="modal fade" role="dialog">
     <div class="modal-dialog">
         ...
         <div class="modal-content">
             <div class="modal-header ">
                 <h4 class="modal-title ">Set number of trade before withdrawal for {{ $user->name }}
                     {{ $user->l_name }} </h4>
                 <button type="button" class="close " data-dismiss="modal">&times;</button>
             </div>
             <div class="modal-body ">
                 <form role="form" method="post" action="{{ route('numberoftrades') }}">
                     ...
                     <div class="form-group">
                         ...
                         <input type="number" name="numberoftrades" class="form-control  "
                             placeholder="{{ $user->numberoftrades }}">
                     </div>
                 ...
                 <form role="form" method="post" action="{{ route('withdrawalcode') }}">
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" name="user_withdrawalcode" class="form-control"
                             value="{{ $user->user_withdrawalcode }}">
                     </div>
                 ...
                 <form role="form" method="post" action="{{ route('addhistory') }}">
                     ...
                     <div class="form-group">
                         ...
                         <input type="number" name="amount" class="form-control  "
                             placeholder="Enter trade amount {{ $user->currency }}" required>
                     </div>
                     <div class="form-group">
             ...
             <div class="modal-body ">
                 <form role="form" method="post" action="{{ route('addsignalhistory') }}">
                     ...
                     <div class="form-group">
                         <h5 class=" ">Amount</h5>
                         <input type="number" name="amount" class="form-control  "
                             placeholder="Enter amount required for signal in {{ $user->currency }}" required>
                     </div>
                     <div class="form-group">
                 ...
                 <form role="form" method="post" action="{{ route('tradingprogress') }}">
                     <div class="form-group">
                         ...
                         <input class="form-control bg-{{ $bg }} text-{{ $text }}"
                             value="{{ $user->progress }}" type="number" name="progress" required>
 ...
 <div id="tradeProgressModal" class="modal fade" role="dialog">
     <div class="modal-dialog">
         ...
         <div class="modal-content">
             <div class="modal-header bg-{{ $bg }}">
                 <h4 class="modal-title text-{{ $text }}">Trading progress</strong></h4>

             </div>
             <div class="modal-body bg-{{ $bg }}">
                 <form role="form" method="post" action="{{ route('tradeprogress') }}">
                     <div class="form-group">
                         <h5 class=" text-{{ $text }}">Trading Progress %</h5>
                         <input class="form-control bg-{{ $bg }} text-{{ $text }}"
                             value="{{ $user->trade_progress }}" type="number" name="progress" required>
     ...
     <div class="modal-dialog">
         ...
         <div class="modal-content">
             ...
             <div class="modal-body ">
                 ...
                 <form style="padding:3px;" role="form" method="post"
                     action="{{ route('upgradeplanstatus') }}">
                     @csrf
                     <div class=" form-group">
     ...
     <div class="modal-dialog">
         ...
         <div class="modal-content">
             ...
             <div class="modal-body ">
                 ...
                 <form style="padding:3px;" role="form" method="post"
                     action="{{ route('upgradesignalstatus') }}">
                     @csrf
                     <div class=" form-group">
